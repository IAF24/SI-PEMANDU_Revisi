...
public class kms_input extends AppCompatActivity implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        bln_penimbangan = (EditText) findViewById( R.id.blnPenimbang);
   ...
   private String getAge(int year, int month, int day){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
     ...
     private void sendData(){
        ...
        final String _bln_penimbangan = bln_penimbangan.getText().toString().trim();
...
// Adding request to request queue
    ...
    public void onClick(View v) {
        if ( v == save ) {
            if (bln_penimbangan.getText().toString().isEmpty() || bb.getText().toString().isEmpty() ||
